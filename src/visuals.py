...
class Display():
    ...
    def update(self):
        ...
        """pygame.draw.rect(self.screen, (195, 170, 87),
                         pygame.Rect(45, 100, 65, 40))
        pygame.draw.rect(self.screen, (195, 170, 87),
                         pygame.Rect(45, 145, 65, 30))
        pygame.draw.rect(self.screen, (195, 170, 87),
                         pygame.Rect(115, 100, 107, 40))
        pygame.draw.rect(self.screen, (195, 170, 87),
                         pygame.Rect(115, 145, 120, 32))
    ...
    """def variables(self):
        tuning_f = self.wave_font.render(
            f"tuning: A={self.tuning}", 1, (35, 35, 35))
